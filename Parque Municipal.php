...
<?php
$tempep = $_SESSION['temp'];
$umidap = $_SESSION['umid'];
$carbp = $_SESSION['carbono'];
...
<head>
  ...
  <title>SportZone - Parque Municipal</title>
</head>
...
<br>
      ...
      <ul class="nav flex-column ml-2">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="Parque Municipal.php">
  ...
  <div class=" col-md-10 bg-light">
    <div class="container">
      ...
      <div class="container-fluid">
        <h4 class="page-title text-center">Parque Municipal</h4>
        <br>
        <div class="row">
          <div class="col-md-4">
              ...
              <div class="card-body  text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text"><?php echo"$tempep"?>°C</h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body  text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text"><?php echo"$umidap"?>%</h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text"><?php echo"$carbp"?> PPM</h5>
                  </div>
                </div>
              </div>
            </div>
  ...
  <a href="facebook.com/devorcz"> SportZone</a>
</div>
      </div>
    </div>
  </div>
