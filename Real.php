...
<head>
  ...
  <title>SportZone - Tempo Real</title>
</head>
  ...
  <div class=" col-md-10 bg-light">
    <div class="container">
      ...
      <div class="container-fluid">
        <h4 class="page-title text-center">local Atual - Tempo Real</h4>
        <br>
        <div class="row">
          <div class="col-md-4">
              ...
              <div class="card-body  text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text" id="temp">°C </h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text" id="carb">PPM</h5>
                  </div>
                </div>
              </div>
            </div>
