...
<head>
  ...
  <title>SportZone - Praça da Liberdade</title>
</head>
...
<br>
      ...
      <ul class="nav flex-column ml-2">
        <li class="nav-item">
          <a class="nav-link active" href="liberdade.php">
  ...
  <div class=" col-md-10 bg-light">
    <div class="container">
      ...
      <div class="container-fluid">
        <h4 class="page-title text-center">Praça da Liberdade</h4>
        <br>
        <div class="row">
          <div class="col-md-4">
              ...
              <div class="card-body  text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text"><?php echo"$tempe"?>°C </h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body  text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text"><?php echo"$umida"?>%</h5>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body text-white">
                <div class="d-flex justify-content-center">
                  <div class="numbers">
                    ...
                    <h5 class="card-text"><?php echo"$carb"?> PPM</h5>
                  </div>
                </div>
              </div>
            </div>
